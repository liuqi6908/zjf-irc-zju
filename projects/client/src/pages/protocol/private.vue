...
<template>
  <div bg-grey-1 p-20 text-grey-8>
    ...
    <div>
      ...
      二、数据/信息的使用
      「社科大数据平台」将对上述收集到的信息进行如下方面的使用：
      记录您的登录或访问信息，方便您能进行正常的登录和访问操作；
      ...
      在必要时共享数据/信息给相关政府部门或第三方。「社科大数据平台」有权应政府部门（包括司法及行政部门）的要求，向其提供您在「 社科大数据平台」使用过程中提供和产生的注册信息、订阅信息、交易记录等必要信息。如您涉嫌侵犯他人知识产权，「社科大数据平台」亦有权在相关法律法规的要求下，向权利人提供您必要的身份信息。
      四、数据/信息的披露
